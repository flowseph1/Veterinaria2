...
function filas(event) {
    ...
    //Guardar ID de Proveedor en input hidden.
    let ProveedorId = event.currentTarget.children[0].innerHTML;
...
const totalFilas = document.getElementsByClassName("ProveedoresTotales")[0];
