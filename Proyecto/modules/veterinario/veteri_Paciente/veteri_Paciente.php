    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../veteri_PacIente/veteri_agregarPaciente.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../veteri_Paciente/veteri_editarPaciente.php'">
                        <div class="image">
