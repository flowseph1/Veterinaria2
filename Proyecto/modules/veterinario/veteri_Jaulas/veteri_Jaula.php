    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                ...
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../veteri_Jaulas/veteri_agregarJaula.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../veteri_Jaulas/veteri_editarJaula.php'">
                        <div class="image">
