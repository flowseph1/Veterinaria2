        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    <div class="motivo">AGREGAR JAULA</div>
                    <div class="atras" onclick="location.href = '../veteri_Jaulas/veteri_Jaula.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                        ...
                        <div class="personal">
                            ...
                            <div class="info-personal">
                                ...
                                <div class="col inputs">
                                    ...
                                    <div class="values">
                                        <input type="text" spellcheck="false" name="correo">
                                        <div class="params-op">
                                            OBLIGATORIO
                                        </div>
                                    </div>
