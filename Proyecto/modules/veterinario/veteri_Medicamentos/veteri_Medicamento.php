...
<head>
    ...
    <title>Veterinario | Medicamento</title>
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    <div class="motivo">Medicamentos</div>
                    <div class="atras" onclick="location.href = '../../veterinario/veterinario.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../veteri_Medicamentos/veteri_agregarMedicamento.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../veteri_Medicamentos/veteri_editarMedicamento.php'">
                        <div class="image">
