...
<head>
    ...
    <title>Veterinario | Recetas</title>
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    <div class="motivo">RECETAS MEDICAS</div>
                    <div class="atras" onclick="location.href = '../../veterinario/veterinario.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                    <div class="boton verde" onclick="location.href = '../veteri_Recetas/veteri_agregarRecetas.php'">
                        <div class="image">
                    ...
                    <div class="boton" id="editar" onclick="location.href = '../veteri_Recetas/veteri_editarRecetas.php'">
                        <div class="image">
