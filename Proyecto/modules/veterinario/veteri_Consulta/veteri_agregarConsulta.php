...
<body>
    ...
    <div class="fondo">
        ...
        <div class="main-user">
            ...
            <div class="contenedor">
                <div class="titulo-opcion">
                    ...
                    <div class="atras" onclick="location.href = '../veteri_Consulta.php'">
                        ATRAS
                    </div>
                </div>
                <div class="botones">
                    <select name="historialMascotas" id="seleccioneMascota" class="selectHistorial color-blanco-transparente">
                        ...
                        for ($i = 0; $i < count($_SESSION['mascotas']); $i++) {
                            $nombreMascota = $_SESSION['mascotas'][$i];
                            $idMascota2 = $_SESSION['idMascotas'][$i];

                            if ($idMascota2 == $_GET["mascota"]) {
                                echo "<option value='$idMascota2' selected> $nombreMascota</option>";
                            } else {
                                echo "<option value='$idMascota2' > $nombreMascota</option>";
                            }
                        }
        ...
        <script src="/Proyecto/statics/js/cliente/clienteHistorial.js"></script>
