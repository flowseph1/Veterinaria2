...
<head>
    ...
    <link rel="stylesheet" href="/Proyecto/statics/css/auxiliar/auxiliar.css">
        ...
        <div class="main-user">
            ...
            <div class="administrar ">
                ...
                <div class="menu-auxiliar">
                    <div class="opcion cliente" onclick="location.href = 'historial/preclinica.php'">
                        <div class="titulo">
                            <div class="tituloPrincipal">PRECLINICA</div>
                        </div>
                        <div class="icono">
