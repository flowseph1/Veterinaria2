...
<head>
  ...
  <link rel="shortcuticon" href="../statics/img/Logo1Mesa de trabajo 1.svg" type="image/x-icon">
</head>
...
<body>
  ...
  <div class="main">
    ...
    <div class="login">
      ...
      <form action="../modules/validacionLogin.php" method="POST">
        <div class="text-box">
          <div class="icon">
            <i class="fas fa-user" style="color: white;"></i>
          </div>
          <input type="text" class="cuadro-texto" placeholder="Usuario" spellcheck="false" id="user" pattern='[A-Za-z0-9-_]{1,15}' name="usuario" />
        </div>
        <div class="text-box">
          <div class="icon">
            <i class="fas fa-lock" style="color: white;"></i>
          </div>
          <input type="password" class="cuadro-texto" spellcheck="false" placeholder="Clave" id="password" pattern='[A-Za-z0-9-_]{1,15}' name="contra" />
        </div>
